...
1. Enter the make, model, year of first registration, and UK purchase price
2. Enter the CO₂ figure (g/km) from the V5C — this drives VRT and motor tax
3. Enter the NOx figure if known (from Revenue's NOx calculator / V5C)
4. Select **Great Britain** or **Northern Ireland** as the car's origin
5. Select **private buyer** or **VAT-registered dealer**
6. Hit **Calculate** — you get a full breakdown in EUR
...
The calculator runs entirely in your browser. The only external request is to the public open.er-api.com exchange-rate API to fetch the current GBP→EUR rate.
